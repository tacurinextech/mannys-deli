...
export const cateringItems: CateringItem[] = [
    {
      name: "Chicken Frances/Pollo A La Francesca",
      description: "Ex velit ad magna cillum.",
      origin: "Italian",
      mediumTray: {
        serves: "10-15",
        price: "$60.00",
    ...
    {
      name: "Chicken Parmesan/Pollo Parmesano",
      description: "Ex velit ad magna cillum.",
      origin: "Italian",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Chicken Tenders/Tiras de Pollo",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Stewed Chicken Gizzards / Mollejas de Pollo Guisado",
      description: "Ex velit ad magna cillum.",
      origin: "Italian",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Stewed Chicken / Pollo Guisado",
      description: "Ex velit ad magna cillum.",
      origin: "Ecuador",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Fried Pork Chop / Chuleta Frita",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Italian Sausage w/ Onions & Peppers",
      description: "Ex velit ad magna cillum.",
      origin: "Italian",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Stewed Beef Oxtail / Colas de Res Guisada",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Stewed Mondongo o Guatita / Tripa de Res",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    //Specialty Dishes
    {
      name: "Chicken Scarpariello w/ Pasta",
      description: "Ex velit ad magna cillum.",
      origin: "Italian",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Sweet Plantain Lasagna / Pastelon",
      description: "Ex velit ad magna cillum.",
      origin: "Puerto Rico",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Shrimp & broccoli Pasta / Camarones y Brocoli Pasta",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Chaulafan con Pollo, Rez o Camaron",
      description: "Ex velit ad magna cillum.",
      origin: "Ecuador",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Yellow Rice w/ Pigeon Peas & Chicken, Pork, Chorizo or Ham",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Salted Vegetables/Vegetales",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Pico De Gallo/Homemade Salsa",
      description: "Ex velit ad magna cillum.",
      origin: "Costa Rica",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Handhamde Tortillas/Tortillas Hecho a Mano",
      description: "Ex velit ad magna cillum.",
      origin: "Mexico",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Freid Sweet Plantains / Maduros",
      description: "Ex velit ad magna cillum.",
      origin: "Ecuador",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Cassava w/ Onions/Yucca con Cebolla",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    {
      name: "Golden Potatoes /  Papas Doradas",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    //Salad
    {
      name: "Ceasar Salad / Ensalada Cesar",
      description: "Ex velit ad magna cillum.",
      origin: "",
      mediumTray: {
        serves: "10-15",
    ...
    //Other
    {
      name: "Beef & Chicken Fajitas",
      description: "Grilled with Peppers and Onions",
      origin: "Mexico",
      mediumTray: {
        serves: "10-15",
        price: "$65.00",
